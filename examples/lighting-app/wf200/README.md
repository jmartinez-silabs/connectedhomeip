...
OR use GN/Ninja directly
          ...
          $ cd ~/connectedhomeip/examples/lighting-app/wf200
...
-   On the command line:
          ...
          $ cd ~/connectedhomeip/examples/lighting-app/wf200
          $ python3 out/debug/efr32-wfx-lighting-example.flash.py
...
-   Once the device is provisioned, it will join the WiFi network

-   Using chip-device-ctrl you can now control the light status with on/off command
    such as `chip-device-ctrl OnOff On 1234 1 0`
...
note that a HEAP size smaller than 12k can and will cause a Mbedtls failure
