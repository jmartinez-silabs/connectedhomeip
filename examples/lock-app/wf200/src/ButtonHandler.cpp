...
void ButtonHandler::GpioInit(void)
{
    ...
    GPIOINT_Init();
    GPIO_ExtIntConfig(sButtonArray[0].port, sButtonArray[0].pin, sButtonArray[0].pin, true, true, true);
    GPIO_ExtIntConfig(sButtonArray[1].port, sButtonArray[1].pin, sButtonArray[1].pin, true, true, true);
