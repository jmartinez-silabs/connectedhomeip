...
class TC_RR_1_1(MatterBaseTest):
    ...
    async def validate_groupcast_resources(
        ...
        try:
            ...
            if "RESOURCE_EXHAUSTED" in str(e) or "0x89" in str(e):
                log.info("  JoinGroup correctly returned RESOURCE_EXHAUSTED")
            else:
                asserts.fail(f"Step 21: Expected RESOURCE_EXHAUSTED, got: {e}")
